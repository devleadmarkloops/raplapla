...
class PromoPopup extends HTMLElement {
  ...
  init() {
    ...
    document.getElementById('newsletter-checkbox').addEventListener('click', function(event) {
      if(event.target.checked == true){
        document.querySelector('[data-newsletter-submit]').classList.remove('button--disabled');
      }else{
        document.querySelector('[data-newsletter-submit]').classList.add('button--disabled');
      }
    });
